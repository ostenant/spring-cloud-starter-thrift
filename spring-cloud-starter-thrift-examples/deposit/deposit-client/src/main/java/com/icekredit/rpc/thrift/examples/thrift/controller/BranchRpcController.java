...
public class BranchRpcController {
    ...
    public Branch getBranchById(@RequestParam("bankId") Long branchId) throws Exception {
        return Branch.fromThrift(thriftClient.thriftClient().getBranchById(branchId));
    }
